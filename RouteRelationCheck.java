...
public class RouteRelationCheck extends BaseCheck<Object>
{
    ...
    private List<String> checkRouteForGaps(final Relation rel)
    {
        ...
        //logger.info("~~~~ allEdges.size(): " + allMainEdges.size() + "~~~~ allLines.size(): " + allLines.size()+
    ...
    private boolean StopsToofar(final Relation rel)
    {
       /* Set<RelationMember> allSigns = rel.members().stream()
        ...
        //logger.info("StopToofar : minSnap.getDistance() {}"+ rel.getIdentifier());
     ...
     * network, opertor, ref, and colour between a route master and its member routes
     *
     * @param rel
